...
using DoctorViewFhirInteractionApi.Attributes;
using DoctorViewFhirInteractionApi.Security;
...
{ 
    ...
    { 
        ...
        [HttpPost]
        [Route("/PranavDesu6/TestApi/1.0.0/pet")]
        [ValidateModelState]
        ...
        [HttpDelete]
        [Route("/PranavDesu6/TestApi/1.0.0/pet/{petId}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/PranavDesu6/TestApi/1.0.0/pet/findByStatus")]
        [ValidateModelState]
        ...
        /// <response code="200">successful operation</response>
        [HttpPost]
        [Route("/PranavDesu6/TestApi/1.0.0/pet/{petId}/uploadImage")]
        [ValidateModelState]
